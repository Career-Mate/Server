...
public class OAuth2AuthorizationRequestBasedOnCookieRepository
    ...
    public OAuth2AuthorizationRequest loadAuthorizationRequest(HttpServletRequest request) {
        ...
        if (authorizationRequestCookie != null) {
            OAuth2AuthorizationRequest authorizationRequest = CookieUtil.deserialize(authorizationRequestCookie,
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request,
        ...
        CookieUtil.addCookie(response, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME,
                CookieUtil.serialize(authorizationRequest), AUTHORIZATION_REQUEST_COOKIE_EXPIRE_SECONDS);
    }
