...
public class RecruitController {
    ...
    public ApiResponse<PageResponseDTO<List<RecommendRecruitDTO>>> getRecommendRecruitList(
        ...
        @RequestParam MemberEducationLevel memberEducationLevel,
        @RequestParam EducationStatus educationStatus) {
        return ApiResponse.onSuccess(
            recruitQueryService.getRecommendRecruitList(page, size, recruitSortType,
                memberEducationLevel, educationStatus));
    }
